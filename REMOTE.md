...
Use this when you want to open Beppo from another device (phone, tablet, another laptop).

## CLI ↔ Env option map

The Beppo CLI accepts the following configuration options, available either as CLI flags or environment variables:
