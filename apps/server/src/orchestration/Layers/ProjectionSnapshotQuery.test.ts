...
projectionSnapshotLayer("ProjectionSnapshotQuery", (it) => {
  ...
  it.effect("preserves sidebar metadata when reading a summary snapshot", () =>
    Effect.gen(function* () {
      const snapshotQuery = yield* ProjectionSnapshotQuery;
      const sql = yield* SqlClient.SqlClient;
      ...
      yield* sql`
        ...
        VALUES
          ...
          (
            ...
            'approval.requested',
            'Need approval',
            '{"requestId":"approval-1","requestKind":"command","detail":"run git status"}',
            '2026-03-10T00:00:07.000Z'
          ),
          (
            'activity-user-input',
            'thread-summary',
            ...
            'Need input',
            '{"requestId":"input-1","questions":[{"id":"q1","header":"Pick","question":"Choose one","options":[{"label":"A","description":"Use A"}]}]}',
            '2026-03-10T00:00:08.000Z'
          )
      `;
      ...
      const snapshot = yield* snapshotQuery.getSnapshot({ scope: "summary" });
      ...
      assert.deepEqual(thread?.proposedPlans, [
        {
          id: "plan-summary",
          turnId: asTurnId("turn-summary"),
          planMarkdown: "# Keep going",
          implementedAt: null,
          implementationThreadId: null,
          createdAt: "2026-03-10T00:00:06.000Z",
          updatedAt: "2026-03-10T00:00:06.000Z",
        },
      ]);
