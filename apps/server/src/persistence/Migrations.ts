...
import Migration0020 from "./Migrations/020_ProjectionTurnsHotQueryIndexes.ts";
import Migration0021 from "./Migrations/021_ProjectionThreadProposedPlanImplementationRecovery.ts";
...
export const migrationEntries = [
  ...
  [20, "ProjectionTurnsHotQueryIndexes", Migration0020],
  [21, "ProjectionThreadProposedPlanImplementationRecovery", Migration0021],
] as const;
