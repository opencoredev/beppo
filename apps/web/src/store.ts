...
function mapProject(
  ...
  return {
    ...
    scripts:
      "scripts" in project && Array.isArray(project.scripts)
        ? mapProjectScripts(project.scripts)
        : [],
  };
}
  ...
  switch (event.type) {
    ...
    case "project.meta-updated": {
      ...
      const nextProject: Project = {
        ...
        ...("repositoryIdentity" in event.payload && event.payload.repositoryIdentity !== undefined
          ? {
              repositoryIdentity:
                (event.payload.repositoryIdentity as Project["repositoryIdentity"]) ?? null,
            }
          : {}),
